(function (root, factory) {
  ...
  "note": "The primary pie uses the Census FY2024 Annual Survey of State Government Finances because its mutually exclusive expenditure function/category rows sum exactly to the map total. Census reports amounts in $1,000 and includes state-government entities defined by its methodology. The prior state-specific layer is retained as a non-additive comparison; its $36,704,047,552.46 total is not assigned to a Census category. Census categories are functions, not payee transactions.",
  "reconciliation": {
    "itemizedDifference": 0,
    "normalized": false,
    "scale": 1,
    "comparisonDifference": 12430854447.54
  },
  "departments": [
    {
      ...
      "amount": 10714881000,
      "sourceAmount": 10714881000,
      "program": "Intergovernmental expenditure · Census FY2024 function/category",
      "sourceRows": 31,
      "detailUrl": "data/state-sc/census-state-sc-fy2024-intergovernmental.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
          "data/state-sc/archive-state-source/state-sc-official-source-summary.json"
        ],
        [
          "Prior official state itemized source",
          "https://cg.sc.gov/fiscal-transparency/monthly-state-spending-transparency-files"
        ]
      ]
    },
    {
      ...
      "amount": 36330552000,
      "sourceAmount": 36330552000,
      "program": "Direct general expenditure · Census FY2024 function/category",
      "sourceRows": 36,
      "detailUrl": "data/state-sc/census-state-sc-fy2024-direct-general.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "amount": 2089469000,
      "sourceAmount": 2089469000,
      "program": "Utility expenditure · Census FY2024 function/category",
      "sourceRows": 4,
      "detailUrl": "data/state-sc/census-state-sc-fy2024-utility.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "sourceRows": 1,
      "detailUrl": "data/state-sc/census-state-sc-fy2024-liquor-stores.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
  ...
  "itemizedTotal": 49134902000,
  "comparison": {
    "label": "Prior official state itemized layer (non-additive)",
    "url": "https://cg.sc.gov/fiscal-transparency/monthly-state-spending-transparency-files",
    "total": 36704047552.46,
    "difference": 12430854447.54
  },
