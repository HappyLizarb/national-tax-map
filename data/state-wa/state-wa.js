(function (root, factory) {
  ...
  "note": "The primary pie uses the Census FY2024 Annual Survey of State Government Finances because its mutually exclusive expenditure function/category rows sum exactly to the map total. Census reports amounts in $1,000 and includes state-government entities defined by its methodology. The prior state-specific layer is retained as a non-additive comparison; its $34,960,860,261.78 total is not assigned to a Census category. Census categories are functions, not payee transactions.",
  "reconciliation": {
    "itemizedDifference": 0,
    "normalized": false,
    "scale": 1,
    "comparisonDifference": 44711310738.22
  },
  "departments": [
    {
      ...
      "amount": 23234638000,
      "sourceAmount": 23234638000,
      "program": "Intergovernmental expenditure · Census FY2024 function/category",
      "sourceRows": 31,
      "detailUrl": "data/state-wa/census-state-wa-fy2024-intergovernmental.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
          "data/state-wa/archive-state-source/state-wa-official-source-summary.json"
        ],
        [
          "Prior official state itemized source",
          "https://fiscal.wa.gov/Spending/VendorPayments2325.xlsx"
        ]
      ]
    },
    {
      ...
      "amount": 56383815000,
      "sourceAmount": 56383815000,
      "program": "Direct general expenditure · Census FY2024 function/category",
      "sourceRows": 36,
      "detailUrl": "data/state-wa/census-state-wa-fy2024-direct-general.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "amount": 53718000,
      "sourceAmount": 53718000,
      "program": "Utility expenditure · Census FY2024 function/category",
      "sourceRows": 4,
      "detailUrl": "data/state-wa/census-state-wa-fy2024-utility.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "sourceRows": 1,
      "detailUrl": "data/state-wa/census-state-wa-fy2024-liquor-stores.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
  ...
  "itemizedTotal": 79672171000,
  "comparison": {
    "label": "Prior official state itemized layer (non-additive)",
    "url": "https://fiscal.wa.gov/Spending/VendorPayments2325.xlsx",
    "total": 34960860261.78,
    "difference": 44711310738.22
  },
