(function (root, factory) {
  ...
  "note": "The primary pie uses the Census FY2024 Annual Survey of State Government Finances because its mutually exclusive expenditure function/category rows sum exactly to the map total. Census reports amounts in $1,000 and includes state-government entities defined by its methodology. The prior state-specific layer is retained as a non-additive comparison; its $43,394,706,192.68 total is not assigned to a Census category. Census categories are functions, not payee transactions.",
  "reconciliation": {
    "itemizedDifference": 0,
    "normalized": false,
    "scale": 1,
    "comparisonDifference": 2788954807.3199997
  },
  "departments": [
    {
      ...
      "amount": 9620248000,
      "sourceAmount": 9620248000,
      "program": "Intergovernmental expenditure · Census FY2024 function/category",
      "sourceRows": 31,
      "detailUrl": "data/state-la/census-state-la-fy2024-intergovernmental.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
          "data/state-la/archive-state-source/state-la-official-source-summary.json"
        ],
        [
          "Prior official state itemized source",
          "https://checkbook.la.gov/expenditures2.cfm"
        ]
      ]
    },
    {
      ...
      "amount": 36555719000,
      "sourceAmount": 36555719000,
      "program": "Direct general expenditure · Census FY2024 function/category",
      "sourceRows": 36,
      "detailUrl": "data/state-la/census-state-la-fy2024-direct-general.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "amount": 7694000,
      "sourceAmount": 7694000,
      "program": "Utility expenditure · Census FY2024 function/category",
      "sourceRows": 4,
      "detailUrl": "data/state-la/census-state-la-fy2024-utility.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "sourceRows": 1,
      "detailUrl": "data/state-la/census-state-la-fy2024-liquor-stores.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
  ...
  "itemizedTotal": 46183661000,
  "comparison": {
    "label": "Prior official state itemized layer (non-additive)",
    "url": "https://checkbook.la.gov/expenditures2.cfm",
    "total": 43394706192.68,
    "difference": 2788954807.3199997
  },
