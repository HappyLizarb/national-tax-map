(function (root, factory) {
  ...
  "note": "The primary pie uses the Census FY2024 Annual Survey of State Government Finances because its mutually exclusive expenditure function/category rows sum exactly to the map total. Census reports amounts in $1,000 and includes state-government entities defined by its methodology. The prior state-specific layer is retained as a non-additive comparison; its $40,390,013,646.72 total is not assigned to a Census category. Census categories are functions, not payee transactions.",
  "reconciliation": {
    "itemizedDifference": 0,
    "normalized": false,
    "scale": 1,
    "comparisonDifference": 23232339353.28
  },
  "departments": [
    {
      ...
      "amount": 12119460000,
      "sourceAmount": 12119460000,
      "program": "Intergovernmental expenditure · Census FY2024 function/category",
      "sourceRows": 31,
      "detailUrl": "data/state-md/census-state-md-fy2024-intergovernmental.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
          "data/state-md/archive-state-source/state-md-official-source-summary.json"
        ],
        [
          "Prior official state itemized source",
          "https://opendata.maryland.gov/resource/7syw-q4cy.json?$select=agency_name,sum(amount)%20as%20amount&$where=fiscal_year=2024&$group=agency_name"
        ]
      ]
    },
    {
      ...
      "amount": 49087158000,
      "sourceAmount": 49087158000,
      "program": "Direct general expenditure · Census FY2024 function/category",
      "sourceRows": 36,
      "detailUrl": "data/state-md/census-state-md-fy2024-direct-general.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "amount": 2415735000,
      "sourceAmount": 2415735000,
      "program": "Utility expenditure · Census FY2024 function/category",
      "sourceRows": 4,
      "detailUrl": "data/state-md/census-state-md-fy2024-utility.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
    ...
    },
    {
      ...
      "sourceRows": 1,
      "detailUrl": "data/state-md/census-state-md-fy2024-liquor-stores.json",
      "sourceUrl": "https://www2.census.gov/programs-surveys/state/data/GS00STATEFIN01.zip",
      "relatedSources": [
        [
          "Prior state layer snapshot",
  ...
  "itemizedTotal": 63622353000,
  "comparison": {
    "label": "Prior official state itemized layer (non-additive)",
    "url": "https://opendata.maryland.gov/resource/7syw-q4cy.json?$select=agency_name,sum(amount)%20as%20amount&$where=fiscal_year=2024&$group=agency_name",
    "total": 40390013646.72,
    "difference": 23232339353.28
  },
